...
export class ConfirmService {
    ...
    public aprobeDialog(item?: any) {
        return new Promise((resolve, reject) => {
            Swal.fire({
                title: 'Las empresas seleccionadas seran enviadas a Evaluación, ¿Desea continuar?',
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Confirmar',
    ...
    public verifiedDialog(item: any) {
        return new Promise((resolve, reject) => {
            Swal.fire({
                title: '¿Confirmar cambio de firmante a ' + item + '?',
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Confirmar',
